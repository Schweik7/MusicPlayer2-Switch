...
$sources = @(
    ...
    (Join-Path $testDir 'duration_test.cpp')
    (Join-Path $testDir 'tagwrite_test.cpp')
    (Join-Path $testDir 'lang_test.cpp')
    ...
    (Join-Path $coreDir 'AudioDuration.cpp')
    (Join-Path $coreDir 'TagWriter.cpp')
    (Join-Path $coreDir 'Lang.cpp')
